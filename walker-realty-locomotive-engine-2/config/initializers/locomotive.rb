Locomotive.configure do |config|
  ...
  config.mailer_sender = 'mlapping@gmail.com'
...
#  require_relative "../../app/models/singlefamily"
  require_relative "../../lib/wrgtn"
#  config.context_assign_extensions = {'homes' => SingleFamilyHome }

  config.context_assign_extensions = {'homes' => Wrgtn::Liquid::Drops::SingleFamilyHomes.new }
